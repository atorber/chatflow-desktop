  ...
  >
    <el-aside width="200px">
      <el-scrollbar>
        <el-menu :default-openeds="['1', '3']">
          <el-sub-menu index="1">
            <template #title>
              <el-icon><message /></el-icon>训练加速
            </template>
            <el-menu-item-group>
              <el-menu-item index="1-1">训练参数</el-menu-item>
              <el-menu-item index="1-2">模型转换</el-menu-item>
            </el-menu-item-group>
            <el-sub-menu index="1-4">
              <template #title>工具包</template>
              <el-menu-item index="1-4-1">并行策略搜索</el-menu-item>
              <el-menu-item index="1-4-1">CKPT加速</el-menu-item>
              <el-menu-item index="1-4-1">BCCL通信库</el-menu-item>
            </el-sub-menu>
          </el-sub-menu>
          <el-sub-menu index="2">
            <template #title>
              <el-icon><message /></el-icon>推理引擎
            </template>
            <el-menu-item-group>
              <el-menu-item index="1-1">推理参数</el-menu-item>
              <el-menu-item index="1-2">模型量化</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
        </el-menu>
      </el-scrollbar>
    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-tag type="success">参数信息</el-tag>

        <el-form :model="form" label-width="auto" style="margin: 20px">
          <el-form-item label="镜像地址">
            <el-input v-model="form.imageUrl" type="textarea" rows="1" />
          </el-form-item>
          <el-form-item label="执行命令">
            <el-input v-model="form.command" type="textarea" rows="15" />
          </el-form-item>
          <el-form-item label="环境变量">
            <el-input v-model="form.env" type="textarea" rows="15" />
          </el-form-item>
          <!-- <el-form-item>
